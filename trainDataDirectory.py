...
train_docs_full = load_pickle(train_filename+'docs_full.pickle')
...
def getTrainAllDocFull():
    return train_docs_full

def getTrainAllDocFullI(indices):
...
def getTrainDocFull(i):
    return train_docs_full[i]
